...
# Define a dictionary of username-password pairs (you can store this data securely, e.g., in a database)
user_credentials = {
    "jason": "apple",
    "alan": "banana",
    'sandy': 'cucumber',
...
# Streamlit app title and sidebar title
st.sidebar.header("Login")

# Sidebar input fields for username and password
